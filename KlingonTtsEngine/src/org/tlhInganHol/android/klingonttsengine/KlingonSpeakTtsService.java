...
public class KlingonSpeakTtsService extends TextToSpeechService implements android.media.MediaPlayer.OnCompletionListener {
    ...
    static {
        ...
        initMap.put("ba-", R.raw.ba0);
        initMap.put("be-", R.raw.be0);
        ...
        initMap.put("Fa-", R.raw.fa0);
        initMap.put("Ga-", R.raw.ga0);
        initMap.put("Ge-", R.raw.ge0);
        initMap.put("GI-", R.raw.gi0);
        initMap.put("Go-", R.raw.go0);
        initMap.put("Gu-", R.raw.gu0);
        ...
        initMap.put("yo-", R.raw.yo0);
        initMap.put("yu-", R.raw.yu0);
        initMap.put("za-", R.raw.za0);
        initMap.put("ze-", R.raw.ze0);
        initMap.put("zI-", R.raw.zi0);
        initMap.put("zo-", R.raw.zo0);
        initMap.put("zu-", R.raw.zu0);
    ...
    static {
        ...
        initMap.put("Gu", R.raw.gu);
        initMap.put("He", R.raw.he);
        initMap.put("Hu", R.raw.hu);
        initMap.put("ja", R.raw.ja);
        initMap.put("je", R.raw.je);
        initMap.put("jo", R.raw.jo);
        initMap.put("QI", R.raw.ki);
        initMap.put("lu", R.raw.lu);
        initMap.put("oy", R.raw.oy);
        initMap.put("po", R.raw.po);
        initMap.put("qo", R.raw.qo);
        initMap.put("ra", R.raw.ra);
        initMap.put("ro", R.raw.ro);
        initMap.put("So", R.raw.so);
    ...
    static {
        ...
        initMap.put("DuD", R.raw.dud);
        initMap.put("DuF", R.raw.duf);
        initMap.put("DuG", R.raw.dug);
        initMap.put("DuH", R.raw.duh);
        initMap.put("Duj", R.raw.duj);
        initMap.put("DuQ", R.raw.duk);
        initMap.put("Dum", R.raw.dum);
        initMap.put("Dun", R.raw.dun);
        initMap.put("Dup", R.raw.dup);
        initMap.put("Duq", R.raw.duq);
        initMap.put("DuS", R.raw.dus);
        initMap.put("Dut", R.raw.dut);
        initMap.put("Duv", R.raw.duv);
        initMap.put("Duy", R.raw.duy);
        initMap.put("Duyz", R.raw.duyz);
        ...
        initMap.put("Gen", R.raw.gen);
        initMap.put("Gep", R.raw.gep);
        initMap.put("Ger", R.raw.ger);
        initMap.put("GeS", R.raw.ges);
        initMap.put("Get", R.raw.get);
        initMap.put("Gev", R.raw.gev);
        initMap.put("Gew", R.raw.gew);
        initMap.put("Gez", R.raw.gez);
        initMap.put("GIb", R.raw.gib);
        initMap.put("GIC", R.raw.gic);
        initMap.put("GIG", R.raw.gig);
        initMap.put("GIH", R.raw.gih);
        initMap.put("GIj", R.raw.gij);
        initMap.put("GIQ", R.raw.gik);
        initMap.put("GIl", R.raw.gil);
        initMap.put("GIm", R.raw.gim);
        initMap.put("GIn", R.raw.gin);
        initMap.put("GIp", R.raw.gip);
        initMap.put("GIq", R.raw.giq);
        initMap.put("GIr", R.raw.gir);
        initMap.put("GIS", R.raw.gis);
        initMap.put("GIt", R.raw.git);
        initMap.put("GIv", R.raw.giv);
        initMap.put("GIx", R.raw.gix);
        initMap.put("GIz", R.raw.giz);
        ...
        initMap.put("Gox", R.raw.gox);
        initMap.put("Goz", R.raw.goz);
        initMap.put("Gub", R.raw.gub);
        initMap.put("GuF", R.raw.guf);
        initMap.put("GuH", R.raw.guh);
        initMap.put("Gum", R.raw.gum);
        initMap.put("Gun", R.raw.gun);
        initMap.put("Gup", R.raw.gup);
        initMap.put("Gur", R.raw.gur);
        initMap.put("GuS", R.raw.gus);
        initMap.put("Guv", R.raw.guv);
        initMap.put("Guyz", R.raw.guyz);
        ...
        initMap.put("jIq", R.raw.jiq);
        initMap.put("jIr", R.raw.jir);
        initMap.put("jIv", R.raw.jiv);
        initMap.put("jIz", R.raw.jiz);
        initMap.put("joC", R.raw.joc);
        ...
        initMap.put("lep", R.raw.lep);
        initMap.put("leq", R.raw.leq);
        ...
        initMap.put("luQ", R.raw.luk);
        initMap.put("lul", R.raw.lul);
        initMap.put("lum", R.raw.lum);
        initMap.put("lun", R.raw.lun);
        ...
        initMap.put("mal", R.raw.mal);
        initMap.put("mam", R.raw.mam);
        initMap.put("man", R.raw.man);
        initMap.put("maq", R.raw.maq);
        initMap.put("mar", R.raw.mar);
        initMap.put("marG", R.raw.marg);
        ...
        initMap.put("pev", R.raw.pev);
        initMap.put("pey", R.raw.pey);
        initMap.put("peyz", R.raw.peyz);
        ...
        initMap.put("qeb", R.raw.qeb);
        initMap.put("qeC", R.raw.qec);
        initMap.put("qeD", R.raw.qed);
        initMap.put("qeF", R.raw.qef);
        initMap.put("qeG", R.raw.qeg);
        initMap.put("qeH", R.raw.qeh);
        initMap.put("qej", R.raw.qej);
        initMap.put("qel", R.raw.qel);
        initMap.put("qem", R.raw.qem);
        initMap.put("qen", R.raw.qen);
        initMap.put("qep", R.raw.qep);
        initMap.put("qeq", R.raw.qeq);
        initMap.put("qeS", R.raw.qes);
        initMap.put("qet", R.raw.qet);
        initMap.put("qev", R.raw.qev);
        initMap.put("qew", R.raw.qew);
        initMap.put("qex", R.raw.qex);
        initMap.put("qey", R.raw.qey);
        initMap.put("qez", R.raw.qez);
        initMap.put("qIb", R.raw.qib);
        initMap.put("qIC", R.raw.qic);
        initMap.put("qID", R.raw.qid);
        initMap.put("qIG", R.raw.qig);
        initMap.put("qIH", R.raw.qih);
        initMap.put("qIj", R.raw.qij);
        initMap.put("qIQ", R.raw.qik);
        initMap.put("qIl", R.raw.qil);
        initMap.put("qIm", R.raw.qim);
        initMap.put("qIn", R.raw.qin);
        initMap.put("qIp", R.raw.qip);
        initMap.put("qIq", R.raw.qiq);
        initMap.put("qIrq", R.raw.qirq);
        initMap.put("qIt", R.raw.qit);
        initMap.put("qIv", R.raw.qiv);
        initMap.put("qIz", R.raw.qiz);
        initMap.put("qoC", R.raw.qoc);
        initMap.put("qoD", R.raw.qod);
        initMap.put("qoG", R.raw.qog);
        initMap.put("qoH", R.raw.qoh);
        initMap.put("qoj", R.raw.qoj);
        initMap.put("qol", R.raw.qol);
        initMap.put("qom", R.raw.qom);
        initMap.put("qon", R.raw.qon);
        initMap.put("qop", R.raw.qop);
        initMap.put("qoq", R.raw.qoq);
        initMap.put("qor", R.raw.qor);
        initMap.put("qorG", R.raw.qorg);
        initMap.put("qoS", R.raw.qos);
        initMap.put("qox", R.raw.qox);
        initMap.put("qoyz", R.raw.qoyz);
        initMap.put("qoz", R.raw.qoz);
        initMap.put("qub", R.raw.qub);
        initMap.put("quC", R.raw.quc);
        initMap.put("quD", R.raw.qud);
        initMap.put("quF", R.raw.quf);
        initMap.put("quG", R.raw.qug);
        initMap.put("quH", R.raw.quh);
        initMap.put("quj", R.raw.quj);
        initMap.put("qul", R.raw.qul);
        initMap.put("qum", R.raw.qum);
        initMap.put("qun", R.raw.qun);
        initMap.put("qup", R.raw.qup);
        initMap.put("quq", R.raw.quq);
        initMap.put("qur", R.raw.qur);
        initMap.put("qurG", R.raw.qurg);
        initMap.put("quS", R.raw.qus);
        initMap.put("qut", R.raw.qut);
        initMap.put("quv", R.raw.quv);
        initMap.put("qux", R.raw.qux);
        initMap.put("quy", R.raw.quy);
        initMap.put("quz", R.raw.quz);
        initMap.put("raC", R.raw.rac);
        initMap.put("raD", R.raw.rad);
        initMap.put("raG", R.raw.rag);
        initMap.put("raH", R.raw.rah);
        initMap.put("raj", R.raw.raj);
        initMap.put("raQ", R.raw.rak);
        initMap.put("ral", R.raw.ral);
        initMap.put("ram", R.raw.ram);
        initMap.put("ran", R.raw.ran);
        initMap.put("rap", R.raw.rap);
        initMap.put("raq", R.raw.raq);
        initMap.put("rar", R.raw.rar);
        initMap.put("raS", R.raw.ras);
        initMap.put("rat", R.raw.rat);
        initMap.put("rav", R.raw.rav);
        initMap.put("raw", R.raw.raw);
        initMap.put("rawz", R.raw.rawz);
        initMap.put("rax", R.raw.rax);
        initMap.put("ray", R.raw.ray);
        initMap.put("rayz", R.raw.rayz);
        initMap.put("raz", R.raw.raz);
        initMap.put("reC", R.raw.rec);
        initMap.put("reD", R.raw.red);
        initMap.put("reG", R.raw.reg);
        initMap.put("reH", R.raw.reh);
        initMap.put("rej", R.raw.rej);
        initMap.put("reQ", R.raw.rek);
        initMap.put("rel", R.raw.rel);
        initMap.put("ren", R.raw.ren);
        initMap.put("rep", R.raw.rep);
        initMap.put("req", R.raw.req);
        initMap.put("reS", R.raw.res);
        initMap.put("ret", R.raw.ret);
        initMap.put("rew", R.raw.rew);
        initMap.put("rex", R.raw.rex);
        initMap.put("rey", R.raw.rey);
        initMap.put("reyz", R.raw.reyz);
        initMap.put("rIC", R.raw.ric);
        initMap.put("rID", R.raw.rid);
        initMap.put("rIG", R.raw.rig);
        initMap.put("rIH", R.raw.rih);
        initMap.put("rIj", R.raw.rij);
        initMap.put("rIQ", R.raw.rik);
        initMap.put("rIl", R.raw.ril);
        initMap.put("rIn", R.raw.rin);
        initMap.put("rIp", R.raw.rip);
        initMap.put("rIq", R.raw.riq);
        initMap.put("rIt", R.raw.rit);
        initMap.put("rIv", R.raw.riv);
        initMap.put("rIx", R.raw.rix);
        initMap.put("rIy", R.raw.riy);
        initMap.put("rIz", R.raw.riz);
        initMap.put("roD", R.raw.rod);
        initMap.put("roG", R.raw.rog);
        initMap.put("roH", R.raw.roh);
        initMap.put("roj", R.raw.roj);
        initMap.put("roQ", R.raw.rok);
        initMap.put("rol", R.raw.rol);
        initMap.put("rom", R.raw.rom);
        initMap.put("ron", R.raw.ron);
        initMap.put("rop", R.raw.rop);
        initMap.put("ror", R.raw.ror);
        initMap.put("roS", R.raw.ros);
        initMap.put("rot", R.raw.rot);
        initMap.put("rox", R.raw.rox);
        initMap.put("roz", R.raw.roz);
        initMap.put("ruC", R.raw.ruc);
        initMap.put("ruG", R.raw.rug);
        initMap.put("ruj", R.raw.ruj);
        initMap.put("ruQ", R.raw.ruk);
        initMap.put("rum", R.raw.rum);
        initMap.put("run", R.raw.run);
        initMap.put("rup", R.raw.rup);
        initMap.put("ruq", R.raw.ruq);
        initMap.put("rur", R.raw.rur);
        initMap.put("ruS", R.raw.rus);
        initMap.put("rut", R.raw.rut);
        initMap.put("ruv", R.raw.ruv);
        initMap.put("rux", R.raw.rux);
        initMap.put("ruz", R.raw.ruz);
        initMap.put("Sab", R.raw.sab);
        initMap.put("SaC", R.raw.sac);
        initMap.put("SaD", R.raw.sad);
        initMap.put("SaF", R.raw.saf);
        ...
        initMap.put("Set", R.raw.set);
        initMap.put("Sev", R.raw.sev);
        initMap.put("Sey", R.raw.sey);
        initMap.put("Sez", R.raw.sez);
        initMap.put("SIb", R.raw.sib);
        initMap.put("SIC", R.raw.sic);
        initMap.put("SID", R.raw.sid);
        initMap.put("SIG", R.raw.sig);
        initMap.put("SIH", R.raw.sih);
        initMap.put("SIj", R.raw.sij);
        initMap.put("SIQ", R.raw.sik);
        initMap.put("SIm", R.raw.sim);
        initMap.put("SIp", R.raw.sip);
        initMap.put("SIq", R.raw.siq);
        initMap.put("SIr", R.raw.sir);
        initMap.put("SIrG", R.raw.sirg);
        initMap.put("SIS", R.raw.sis);
        initMap.put("SIv", R.raw.siv);
        initMap.put("SIy", R.raw.siy);
        initMap.put("SoC", R.raw.soc);
        initMap.put("SoD", R.raw.sod);
        initMap.put("SoG", R.raw.sog);
        initMap.put("SoH", R.raw.soh);
        initMap.put("Soj", R.raw.soj);
        initMap.put("SoQ", R.raw.sok);
        initMap.put("Sol", R.raw.sol);
        initMap.put("Som", R.raw.som);
        initMap.put("Son", R.raw.son);
        initMap.put("Sop", R.raw.sop);
        initMap.put("Soq", R.raw.soq);
        initMap.put("Sor", R.raw.sor);
        initMap.put("SorG", R.raw.sorg);
        initMap.put("SoS", R.raw.sos);
        initMap.put("Sot", R.raw.sot);
        initMap.put("Sov", R.raw.sov);
        initMap.put("Soy", R.raw.soy);
        initMap.put("Soyz", R.raw.soyz);
        initMap.put("Soz", R.raw.soz);
        initMap.put("Sub", R.raw.sub);
        initMap.put("SuC", R.raw.suc);
        initMap.put("SuD", R.raw.sud);
        initMap.put("SuF", R.raw.suf);
        initMap.put("SuG", R.raw.sug);
        initMap.put("SuH", R.raw.suh);
        initMap.put("Suj", R.raw.suj);
        initMap.put("SuQ", R.raw.suk);
        initMap.put("Sum", R.raw.sum);
        initMap.put("Sun", R.raw.sun);
        initMap.put("Sup", R.raw.sup);
        initMap.put("Suq", R.raw.suq);
        initMap.put("Sur", R.raw.sur);
        initMap.put("SurG", R.raw.surg);
        initMap.put("SuS", R.raw.sus);
        initMap.put("Sut", R.raw.sut);
        initMap.put("Suv", R.raw.suv);
        initMap.put("Sux", R.raw.sux);
        initMap.put("Suy", R.raw.suy);
        initMap.put("Suyz", R.raw.suyz);
        initMap.put("Suz", R.raw.suz);
        ...
        initMap.put("var", R.raw.var);
        initMap.put("varG", R.raw.varg);
        initMap.put("vaS", R.raw.vas);
        initMap.put("vat", R.raw.vat);
        ...
        initMap.put("voy", R.raw.voy);
        initMap.put("voyz", R.raw.voyz);
        ...
        initMap.put("xop", R.raw.xop);
        initMap.put("xorG", R.raw.xorg);
        initMap.put("xoS", R.raw.xos);
        initMap.put("xot", R.raw.xot);
        initMap.put("xov", R.raw.xov);
        initMap.put("xoy", R.raw.xoy);
        initMap.put("xoyz", R.raw.xoyz);
        initMap.put("xoz", R.raw.xoz);
        ...
        initMap.put("yum", R.raw.yum);
        initMap.put("yup", R.raw.yup);
        initMap.put("yur", R.raw.yur);
        initMap.put("yuS", R.raw.yus);
